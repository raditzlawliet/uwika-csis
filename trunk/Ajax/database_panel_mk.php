...
switch($code){
	case 'db_mk' : { //db mahasiswa
			...
			<div id="top"></div>
				...
				<div id="db_cmd"><a id="refresh_blue" class="submit" onclick="javascript:search(\'db_mk\');" href="#!">Refresh</a>&nbsp;<a id="add_blue" class="submit" onclick="javascript:edit_db_mk(1,null);" href="#!">Add New Subject</a>&nbsp;<a id="refresh" class="submit" onclick="javascript:resetSKS();" href="#!">Refresh SKS for KRS</a>&nbsp;<a id="add" class="submit" onclick="javascript:resetSemester(1,true);" href="#!">1 Semester</a>&nbsp;<a id="del" class="submit" onclick="javascript:resetSemester(1,false);" href="#!">1 Semester</a>
				...
				'.getTabelDatabaseMataKuliah("","","kode_mata_kuliah","ASC","blue").'
				</div><p></center>
				...
				'.getTabelDatabaseMataKuliah_Dosen("","","kode_mata_kuliah","ASC","red").'
				</div><p></center>

				<center><h1 style="letter-spacing:20px;"><b>SUBJECT - JURUSAN</b></h1><p>
				<div id="db_cmd">
				Default Panel : <input  onchange="javascript:SetHeightMkKeyUp(this,1)" onKeyUp="javascript:SetHeightMkKeyUp(this,0)" id="set_height_mk_list" name="set_height_mk_list" type="text" style="font-size:9px;" size="2" maxlength="5" value="'.$set_height_mk_list.'"/> px 
				</div>
				<div style="text-align:left;padding-left:25px;">
				...
				'.getTabelDatabaseMataKuliah_Jurusan("","","kode_mata_kuliah","ASC","yellow").'
				</div><p></center>
				...
				'.getTabelDatabaseMataKuliah_Mahasiswa("","","kode_mata_kuliah","ASC","red").'
				</div><p></center>
				...
				'.getTabelDatabaseMataKuliah_Syarat("","","kode_mata_kuliah","ASC","blue").'
				</div><p></center>
				<a href="#top">TOP</a>
				...
				function search(db){
					...
					if((search_text==null)||(search_text=="")||(search_text==" ")||(search_text=="  ")){
						...
						$.post("Ajax/database_ajax_mk.php",{code:db, search_text:"", search_in:"", sort_text:sort_text, sort_by:sort_by, color:color}, function(data) {
						...
						if(db=="db_mk_m")$("#db_mata_kuliah_mahasiswa").html(\'<div><center><img src="images/throbber_white.gif"></center></div>\');
						if(db=="db_mk_s")$("#db_mata_kuliah_syarat").html(\'<div><center><img src="images/throbber_white.gif"></center></div>\');
						$.post("Ajax/database_ajax_mk.php",{code:db, search_text:search_text, search_in:search_in, sort_text:sort_text, sort_by:sort_by, color:color}, function(data) {																								
							if(db=="db_mk")$("#db_mata_kuliah").html(data);
							if(db=="db_mk_d")$("#db_mata_kuliah_dosen").html(data);
							if(db=="db_mk_j")$("#db_mata_kuliah_jurusan").html(data);
							if(db=="db_mk_m")$("#db_mata_kuliah_mahasiswa").html(data);
