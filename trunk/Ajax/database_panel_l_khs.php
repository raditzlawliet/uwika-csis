...
switch($code){
	case 'db_l_m' : { //db mahasiswa
			...
			$out = '<br>
				...
				<tr><td>Auto script : <a id="refresh_pink" class="submit" onclick="javascript:asKey(\'as_lulus\');" href="#!">MK yang Telah Lulus</a>&nbsp;<a id="refresh_pink" class="submit" onclick="javascript:asKey(\'as_krs\');" href="#!">List KRS Mahasiswa [T]</a>&nbsp;<div id="showr" style="float:right;"><form style="margin:-4px;float:right;" action="Ajax/report_l_m.php" method="post"><input style="border:1px solid #FFB0FF;background:#FFB0FF;font-size:11px;margin:3px;"; type="submit" value="Tampilkan Laporan Semua Mahasiswa !"/><input name="code" type="hidden" value="db_l_m" /><input name="search_text" type="hidden" value="\'+search_text+\'" /><input name="search_in" type="hidden" value="\'+search_in+\'" /><input name="sort_text" type="hidden" value="\'+sort_text+\'" /><input name="sort_by" type="hidden" value="\'+sort_by+\'" /><input name="color" type="hidden" value="\'+color+\'" /><input name="page" type="hidden" value="\'+page+\'" /><input name="limit" type="hidden" value="\'+limit+\'" /><input name="show" type="hidden" value="\'+show+\'" /><input name="search2" type="hidden" value="\'+search2+\'" /><input name="sx" type="hidden" value="\'+sx+\'" /><input name="ad" type="hidden" value="\'+ad+\'" /><input name="all" type="hidden" value="all" /></form></div></td></tr></table>
				<table id="show">
				...
				function searchpage(db,page){
					...
					$("#showr").html(\'<form style="margin:-4px;float:right;" action="Ajax/report_l_m.php" method="post"><input style="border:1px solid #FFB0FF;background:#FFB0FF;font-size:11px;margin:3px;"; type="submit" value="Tampilkan Laporan Semua Mahasiswa !"/><input name="code" type="hidden" value="db_l_m" /><input name="search_text" type="hidden" value="\'+search_text+\'" /><input name="search_in" type="hidden" value="\'+search_in+\'" /><input name="sort_text" type="hidden" value="\'+sort_text+\'" /><input name="sort_by" type="hidden" value="\'+sort_by+\'" /><input name="color" type="hidden" value="\'+color+\'" /><input name="page" type="hidden" value="\'+page+\'" /><input name="limit" type="hidden" value="\'+limit+\'" /><input name="show" type="hidden" value="\'+show+\'" /><input name="search2" type="hidden" value="\'+search2+\'" /><input name="sx" type="hidden" value="\'+sx+\'" /><input name="ad" type="hidden" value="\'+ad+\'" /><input name="all" type="hidden" value="all" /></form>\');
